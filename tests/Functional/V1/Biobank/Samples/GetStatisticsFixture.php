...
final class GetStatisticsFixture extends AbstractFixture
{
    public function load(ObjectManager $manager): void
    {
        ...
        $manager->persist(
            new Sample(new SampleData(
                new Id('709e6e08-2edf-401f-bbe3-145398606f52'),
                SampleTypeEnum::PSRER,
                $specie1,
                new Code('sample2'),
            ))
        ...
        $manager->persist(
            new Sample(
                new SampleData(
                    new Id('709e6e08-2edf-401f-bbe3-145398606f53'),
                    SampleTypeEnum::PSRER,
                    $specie2,
                    new Code('sample3'),
                )

...
final class UpdateSpecieFixture extends AbstractFixture
{
    public function load(ObjectManager $manager): void
    {
        ...
        $manager->persist(new Specie(new SpecieData(new Id('709e6e08-2edf-401f-bbe3-145398606f52'), new SpecieName('Canis lupus familiaris'))));
